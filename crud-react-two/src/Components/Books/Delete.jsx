            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Delete Confimation</h5>
                        <button type="button" className="btn-close" onClick={_ => setDeleteBook(null)}></button>
                    </div>
                    <div className="modal-body">
                        <p>Are you sure you want to delete book <strong>{deleteBook.title}</strong>?</p>
                    </div>
                    <div className="modal-footer">
                        <button type="button" className="btn btn-secondary" onClick={_ => setDeleteBook(null)}>Close</button>
